...
#Missing one.
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
                  ...
                  $PokemonBag.pbDeleteItem(@itemF,@quant) if @itemF != :NO
                  $PokemonBag.pbDeleteItem(@itemG,@quant) if @itemG != :NO
                  $PokemonBag.pbDeleteItem(@itemI,@quant) if @itemI != :NO
		          crafts = CraftsList.getcrafts
                  @itemA=:NO
                  @itemB=:NO
                  @itemC=:NO
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
#missing two.
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) && #1
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][7])>=@quant || CraftsList.getcrafts[@currentArray][7]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #2
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][7])>=@quant || CraftsList.getcrafts[@currentArray][7]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #3
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][7])>=@quant || CraftsList.getcrafts[@currentArray][7]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #5
		    ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][7])>=@quant || CraftsList.getcrafts[@currentArray][7]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #6
		    ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #7
		    ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
            ...
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][9])>=@quant || CraftsList.getcrafts[@currentArray][9]==:NO)
              ...
              Kernel.pbMessage(_INTL("You don't have the ingredients to craft this many items! 1"))
          elsif ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][2])>=@quant ||  || CraftsList.getcrafts[@currentArray][2]==:NO) && #8
		    ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][3])>=@quant || CraftsList.getcrafts[@currentArray][3]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][4])>=@quant || CraftsList.getcrafts[@currentArray][4]==:NO) &&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][5])>=@quant || CraftsList.getcrafts[@currentArray][5]==:NO)&&
            ($PokemonBag.pbQuantity(CraftsList.getcrafts[@currentArray][6])>=@quant || CraftsList.getcrafts[@currentArray][6]==:NO)&&
