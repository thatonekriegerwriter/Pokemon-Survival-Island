...
class PokeSearch_Scene
  ITEMTEXTBASECOLOR    = Color.new(64,64,64)
  ITEMTEXTSHADOWCOLOR  = Color.new(168,184,192)
  ...
  def description(item)
    case item
    when :REPEL
      return _INTL("Because of the Stealth Spray there is a decent chance of an encounter.")
    when :SUPERREPEL
      return _INTL("Because of the Super Stealth Spray there is a good chance of an encounter.")
    when :MAXREPEL
      return _INTL("Because of the Max Stealth Spray an encounters are guaranteed.")
    when :LUMBERRY
